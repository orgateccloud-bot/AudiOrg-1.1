...
|---|---|--:|--:|---|
| A-00 | ✅ APROVADO | 0.00 | 83.5 | `status, confidence, decisao, score, score_risco` |
| A-01 | ✅ APROVADO | 0.95 | 6.1 | `destino, ms` |
| A-02 | ✅ APROVADO | 0.90 | 484.8 | `status, confidence, decisao, score, score_risco` |
| A-03 | ✅ ESCALADO | 0.85 | 4.1 | `status, confidence, decisao, score, score_risco` |
| A-04 | ✅ APROVADO | 0.88 | 3.6 | `status, confidence, decisao, score, score_risco` |
| A-05 | ✅ ESCALADO | 0.85 | 1.6 | `status, confidence, decisao, score, score_risco` |
| A-06 | ✅ APROVADO | 0.85 | 1.6 | `status, confidence, decisao, score, score_risco` |
| A-07 | ✅ ESCALADO | 0.80 | 15.5 | `status, confidence, decisao, score, score_risco` |
| A-08 | ✅ APROVADO | 0.95 | 15.8 | `` |
| A-09 | ✅ APROVADO | 0.50 | 62.4 | `risco_ti, vulnerabilidades, recomendacoes, status, confidence` |
| A-10 | ✅ APROVADO | 0.88 | 51.4 | `status, confidence, decisao, score, score_risco` |
| A-11 | ✅ APROVADO | 0.85 | 1.5 | `status, confidence, decisao, score, score_risco` |
| A-12 | ✅ APROVADO | 0.90 | 49.8 | `status, confidence, decisao, score, score_risco` |
| A-13 | ✅ APROVADO | 0.88 | 2.5 | `status, confidence, decisao, score, score_risco` |
| A-14 | ✅ APROVADO | 0.89 | 50.2 | `status, confidence, decisao, score, score_risco` |
| A-15 | ✅ APROVADO | 0.91 | 49.9 | `status, confidence, decisao, score, score_risco` |
| A-16 | ✅ APROVADO | 0.33 | 54.8 | `risco_lgpd, dados_sensiveis_expostos, recomendacoes_anonimizacao, status, confidence` |
| A-17 | ✅ APROVADO | 0.82 | 2.5 | `status, confidence, decisao, score, score_risco` |
| A-18 | ✅ APROVADO | 0.30 | 1.7 | `resumo_executivo, kpis, riscos_prioritarios, oportunidades, proximos_passos` |
| A-19 | ✅ APROVADO | 0.00 | 1.0 | `lancamentos, total_debitos, total_creditos, status, confidence` |
| A-20 | ✅ APROVADO | 0.08 | 1.6 | `trabalhadores, folha_total, contribuicao_previdenciaria, senar, pendencias_esocial` |
| A-21 | ✅ APROVADO | 0.87 | 3.2 | `status, confidence, decisao, score, score_risco` |
| A-22 | ✅ APROVADO | 0.86 | 2.1 | `status, confidence, decisao, score, score_risco` |
| A-23 | ✅ APROVADO | 0.42 | 4.6 | `status, confidence, decisao, score, score_risco` |
| A-24 | ✅ APROVADO | 0.90 | 13.6 | `notas_cfop, total_divergencias` |
| A-25 | ✅ APROVADO | 0.89 | 7.2 | `status, confidence, decisao, score, score_risco` |
| A-26 | ✅ APROVADO | 0.91 | 90.9 | `notas_classificadas, analise` |
| A-27 | ✅ APROVADO | 0.85 | 782.3 | `analise, metricas_grafo, score_conluio` |
