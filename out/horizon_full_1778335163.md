...
|---|---|--:|--:|---|
| A-00 | ✅ APROVADO | 0.00 | 90.4 | `status, confidence, decisao, score, score_risco` |
| a01_junior | ❌ ModuleNotFoundError: No module named 'horizon_blue_one.core. | — | 7.2 | — |
| A-02 | ✅ APROVADO | 0.90 | 491.4 | `status, confidence, decisao, score, score_risco` |
| A-03 | ✅ ESCALADO | 0.85 | 8.4 | `status, confidence, decisao, score, score_risco` |
| A-04 | ✅ APROVADO | 0.88 | 3.0 | `status, confidence, decisao, score, score_risco` |
| A-05 | ✅ ESCALADO | 0.85 | 1.6 | `status, confidence, decisao, score, score_risco` |
| A-06 | ✅ APROVADO | 0.85 | 2.1 | `status, confidence, decisao, score, score_risco` |
| A-07 | ✅ ESCALADO | 0.80 | 17.6 | `status, confidence, decisao, score, score_risco` |
| A-08 | ✅ APROVADO | 0.95 | 17.2 | `` |
| A-09 | ✅ APROVADO | 0.50 | 61.0 | `risco_ti, vulnerabilidades, recomendacoes, status, confidence` |
| A-10 | ✅ APROVADO | 0.88 | 58.0 | `status, confidence, decisao, score, score_risco` |
| A-11 | ✅ APROVADO | 0.85 | 5.9 | `status, confidence, decisao, score, score_risco` |
| A-12 | ✅ APROVADO | 0.90 | 50.1 | `status, confidence, decisao, score, score_risco` |
| A-13 | ✅ APROVADO | 0.88 | 2.7 | `status, confidence, decisao, score, score_risco` |
| A-14 | ✅ APROVADO | 0.89 | 53.1 | `status, confidence, decisao, score, score_risco` |
| A-15 | ✅ APROVADO | 0.91 | 62.1 | `status, confidence, decisao, score, score_risco` |
| A-16 | ✅ APROVADO | 0.33 | 66.2 | `risco_lgpd, dados_sensiveis_expostos, recomendacoes_anonimizacao, status, confidence` |
| A-17 | ✅ APROVADO | 0.82 | 5.5 | `status, confidence, decisao, score, score_risco` |
| A-18 | ✅ APROVADO | 0.30 | 4.9 | `resumo_executivo, kpis, riscos_prioritarios, oportunidades, proximos_passos` |
| A-19 | ✅ APROVADO | 0.00 | 4.0 | `lancamentos, total_debitos, total_creditos, status, confidence` |
| A-20 | ✅ APROVADO | 0.08 | 2.3 | `trabalhadores, folha_total, contribuicao_previdenciaria, senar, pendencias_esocial` |
| A-21 | ✅ APROVADO | 0.87 | 4.2 | `status, confidence, decisao, score, score_risco` |
| A-22 | ✅ APROVADO | 0.86 | 3.6 | `status, confidence, decisao, score, score_risco` |
| A-23 | ✅ APROVADO | 0.42 | 3.4 | `status, confidence, decisao, score, score_risco` |
| A-24 | ✅ APROVADO | 0.90 | 22.8 | `notas_cfop, total_divergencias` |
| A-25 | ✅ APROVADO | 0.89 | 3.1 | `status, confidence, decisao, score, score_risco` |
| A-26 | ✅ APROVADO | 0.91 | 85.5 | `notas_classificadas, analise` |
| A-27 | ✅ APROVADO | 0.85 | 1158.9 | `analise, metricas_grafo, score_conluio` |
